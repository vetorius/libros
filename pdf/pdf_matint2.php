...
$sql  = "SELECT l.titulo, l.precio, m.materia, e.editorial ";
...
if ($base->numregistros()>0) {
	...
	$pdf->SetY(25);
	$titulo = "Materiales de uso interno para ".$curso[$i-1];
	$titulo .= "\n" . date('j/n/Y - G:i');
	...
	$header = array ("Editorial","Materia","Título","Precio"," "," "," ");
