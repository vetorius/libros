 ...
 *
 * archivo pdf_form_rep.php
 *
 * genera un PDF con las hojas de pedido de los repetidores
 *
 */
...
for ($cur=1; $cur<7 ;$cur++) {
	...
	$sql  = "SELECT id_alumno, nom, ap1, ap2, clase ";
	$sql .= "FROM alumnos ";
	$sql .= "WHERE id_curso=$cur and repite=1 and baja=0 ";
