 ...
 *
 * archivo hojas_pedido.php
 *
 * seleccion del grupo para generar hojas de pedido en PDF
 *
 */
...
<body>
<form action="pdf/pdf_form.php" target="_blank" method="GET">
...
<a href="pdf/pdf_form_rep.php" target="_blank">Hojas de pedido para repetidores</a>
